#Exercise 5.4
#Daddy_Son_Program with Grand father

# Daddy_Son Dictionary

daddy_son = { "Rahul" : "Shiv",
              "Shiv" : "Shank",
              "Shank" : "Appa" }
...
#Displaying only the list of Sons and father pair
        ...
        son_new = input ("\n\nEnter the name of the son whose grandfather needs to be found: ")
        if son_new in daddy_son:
            daddy_new = daddy_son [son_new]
            grandfather = daddy_son [daddy_new]
            print ("\n\nGrand father of", son_new, "is: ", grandfather)
        else:
            print ("\n\nThe name of Son does not exist")
